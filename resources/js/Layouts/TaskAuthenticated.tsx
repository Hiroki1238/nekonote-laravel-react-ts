...
export default function TaskAuthenticated({ auth, header, children }: Props) {
            ...
            <main className="flex max-w-full h-full justify-around">
                <div className="w-1/6 bg-white border-r-2 border-gray-400 text-center">
                    ...
                    <p className="mt-3 text-2xl">
                        <Link href="/groups/tasks/1">バイト</Link>
                    </p>

                    <p className="mt-3 text-2xl">
                        <Link href="/groups/tasks/2">会社</Link>
                    </p>

                    <p className="mt-3 text-2xl">
                        <Link href="/groups/tasks/3">ネコ軍団</Link>
                    </p>

                    <p className="mt-3 text-2xl">
                        <Link href="/groups/tasks/4">サイドバー（仮）</Link>
                    </p>
